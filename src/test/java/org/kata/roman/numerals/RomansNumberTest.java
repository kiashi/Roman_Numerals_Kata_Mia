...
public class RomansNumberTest {
    ...
    public void testXIV(){
        ...
        assertEquals(14, romanNumber.toRegularNumber().value());
    }
    ...
    public void testXXXVI() {
        ...
        assertEquals(36, romanNumber.toRegularNumber().value());
    }
    ...
    public void testIX() {
        ...
        assertEquals(9, romanNumber.toRegularNumber().value());
    }
    ...
    public void testXIII() {
        ...
        assertEquals(13, romanNumber.toRegularNumber().value());
    }
    ...
    public void testXVI() {
        ...
        assertEquals(16, romanNumber.toRegularNumber().value());
    }
    ...
    public void testCDLIV() {
        ...
        assertEquals(454, romanNumber.toRegularNumber().value());
    }
    ...
    public void testXLI() {
        ...
        assertEquals(41, romanNumber.toRegularNumber().value());
    }
    ...
    public void testLVII() {
        ...
        assertEquals(57, romanNumber.toRegularNumber().value());
    }
    ...
    public void testDCCXI() {
        ...
        assertEquals(711, romanNumber.toRegularNumber().value());
    }
    ...
    public void testCCCXL() {
        ...
        assertEquals(340, romanNumber.toRegularNumber().value());
    }
    ...
    public void testMCCXXXIV() {
        ...
        assertEquals(1234, romanNumber.toRegularNumber().value());
    }
    ...
    public void testMCMLXXXIX() {
        ...
        assertEquals(1989, romanNumber.toRegularNumber().value());
    }
    ...
    public void testMMCXXXVIII() {
        ...
        assertEquals(2138, romanNumber.toRegularNumber().value());
    }
    ...
    public void testMMCCXXII() {
        ...
        assertEquals(2222, romanNumber.toRegularNumber().value());
    }
}
